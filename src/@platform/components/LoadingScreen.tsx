/**
 * @platform/components/LoadingScreen.tsx
 ...
 * Can be used as a full-screen loader or overlay on top of existing content
 *
 * @param message - Main loading message
 * @param subMessage - Secondary loading message
 * @param isOverlay - If true, uses semi-transparent overlay; if false, uses full opaque background
 */
