...
import { GameState, ModalType, ModalData, Lifelines, UserInfo, Question } from '@game/types';

// Combine all slice types
export type GameStoreState = PlayerSlice & SystemSlice & GameSessionSlice & LogSlice & EventSlice;
...
export const gameActions = {
  ...
  setQuestionPoolFromEngine: (pool: { questions: Question[], backups: Question[] }) => useGameStore.getState().setQuestionPoolFromEngine(pool),
