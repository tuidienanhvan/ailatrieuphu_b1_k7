      ...
      <div className="ml-auto flex items-center h-full">
        ...
        <div className="flex items-center h-full border-r border-white/10">
            <button
                ...
                className={`
                    h-full px-6 flex flex-col items-center justify-center gap-1 transition-all
                    ${isHistoryActive ? 'bg-blue-900/20 text-blue-400' : 'text-slate-400 hover:bg-white/5 hover:text-white'}
                `}
                title="Lịch sử đấu"
            >
                <History size={24} />
