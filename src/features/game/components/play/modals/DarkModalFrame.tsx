...
export const DarkModalFrame: React.FC<DarkModalFrameProps> = ({ children, title, icon: Icon, onClose, variant = "default" }) => {
    ...
    return (
        <div className="absolute inset-0 z-[100] bg-black/95 backdrop-blur-sm flex items-center justify-center animate-fade-in">
            ...
            >
                ...
                <div className="flex-1 w-full relative overflow-hidden flex flex-col p-8 z-10">
                    {children}
                </div>
            </div>
        </div>
