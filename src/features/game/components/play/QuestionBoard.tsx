...
export const QuestionBoard: React.FC<QuestionBoardProps> = ({ timer, maxDuration }) => {
    ...
    <div className="w-full flex flex-col items-center relative z-10 px-16 mt-6 mb-4">
        ...
        <div className="relative w-full max-w-[1400px] z-10">
            ...
            <div className="relative z-10 w-full min-h-[380px] flex flex-col items-center justify-center pt-24 pb-12 px-24 text-center">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-[64px] font-black text-white leading-[1.1] tracking-tight font-sans drop-shadow-[0_4px_10px_rgba(0,0,0,1)] text-balance animate-fade-in relative z-20">
                    <LatexDisplay text={questionText} />
                </h2>
