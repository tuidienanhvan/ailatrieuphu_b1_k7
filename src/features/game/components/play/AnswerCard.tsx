      ...
      <div className="relative flex-1 flex items-stretch -ml-6 py-1 pr-4 z-20">
          ...
          >
              ...
              <div className="flex-1 min-w-0 relative z-10">
                  <div className={`text-xl md:text-2xl lg:text-[28px] font-bold tracking-tight leading-tight transition-all duration-300 ${state === 'default' ? 'text-slate-400 group-hover:text-white' : 'text-white'}`}>
