...
import { usePlayScreen } from '../../../hooks/play/usePlayScreen';
import { TIMER_DURATION, PHONE_HELPERS, PRIZES } from '../../../data/game-constants';
...
// Events
import { SystemErrorOverlay } from '../../../events/pranks/system-error/SystemErrorOverlay';
import { useSystemError } from '../../../events/pranks/system-error/useSystemError';
...
export const PlayScreen: React.FC = () => {
    ...
    return (
        <div className="flex-1 flex flex-row w-full h-full relative overflow-visible animate-fade-in bg-black">
            ...
            {/* --- SIDEBAR PRIZES --- */}
            <SidebarPrizes prizes={PRIZES} currentLevel={currentLevel} currentTier={1} />
