...
import { usePurchase } from '../features/game/hooks/shop/usePurchase';

export const ShopScreen: React.FC = () => {
  // 1. Logic danh sách, tab & điều hướng
  const { items, activeTab, selectedItemId, setActiveTab, handleSelectItem, handleBack } = useShop();

  // 2. Logic mua hàng & modal & số dư
  const { isOpen, itemToBuy, balance, openBuyModal, closeBuyModal, confirmPurchase } = usePurchase();
